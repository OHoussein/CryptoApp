...
private class MockedUseCase: GetCryptoDetailsUseCase {
    var errorOnRefresh = false
    let cryptoDetails = CryptoDetailsModel(
        id: "bitcoin",
        name: "Bitcoin",
        symbol: "BTC",
    ...
    func getAsWrapper(cryptoId _: String) -> CoroutinesToolsFlowWrapper<CryptoDetailsModel> {
