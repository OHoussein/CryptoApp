Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/coroutineTools.framework') || Dir.empty?('build/cocoapods/framework/coroutineTools.framework')
        raise "

        Kotlin framework 'coroutineTools' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :shared:core:coroutinesTools:generateDummyFramework
