Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/sharedModules.framework') || Dir.empty?('build/cocoapods/framework/sharedModules.framework')
        raise "

        Kotlin framework 'sharedModules' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :shared:core:sharedModules:generateDummyFramework
