...
object DataPreview {
    ...
    val previewCryptoDetails by lazy {
        dev.ohoussein.crypto.presentation.model.CryptoDetails(
            ...
            sentimentUpVotesPercentage = dev.ohoussein.crypto.presentation.model.LabelValue(
                64.0,
                "64 %"
            ),
            sentimentDownVotesPercentage = dev.ohoussein.crypto.presentation.model.LabelValue(
                37.0,
                "37 %"
            ),
