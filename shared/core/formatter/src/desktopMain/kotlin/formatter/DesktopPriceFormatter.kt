...
class DesktopPriceFormatter(private val localeId: String) : PriceFormatter {
...
actual fun getPriceFormatter(localeId: String): PriceFormatter = DesktopPriceFormatter(localeId)
